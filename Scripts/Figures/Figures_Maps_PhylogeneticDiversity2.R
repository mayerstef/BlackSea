...
(map_PD <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           ...
                                           colour = "black")))
map_PD
ggsave("./Maps3/PD.png", map_PD, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_PD_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/PD_SES.png", map_PD_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_NTI <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/NTI.png", map_NTI, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_NTI_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/NTI_SES.png", map_NTI_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_NRI <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/NRI.png", map_NRI, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_NRI_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/NRI_SES.png", map_NRI_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_MPD_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/MPD_SES.png", map_MPD_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_MNTD_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/MNTD_SES.png", map_MNTD_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_VPD_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/VPD_SES.png", map_VPD_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_VNTD_SES <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/VNTD_SES.png", map_VNTD_SES, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_zscore_ts <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/zscore_ts.png", map_zscore_ts, width = 10, height = 6.5, dpi = 300, bg = "transparent")
...
(map_zscore_rw <- ggplot() + 
    ...
    theme(panel.background = element_blank(),
          ...
          legend.background = element_rect(fill = "white",
                                           size = 0.5, linetype = "solid", 
                                           colour = "black")))
ggsave("./Maps3/zscore_rw.png", map_zscore_rw, width = 10, height = 6.5, dpi = 300, bg = "transparent")
